...
export default function ApiData() {
    ...
    useEffect(() => {
        globeEl.current.pointOfView({lat: apiData.latitude, lng: apiData.longitude, altitude: 1.4 }, 1000);
    }, [apiData]);

    useEffect(() => {
        globeEl.current.pointOfView({lat: specificIpData.lat, lng: specificIpData.lng, altitude: 1.4 }, 1000);
    }, [specificIpData]);
