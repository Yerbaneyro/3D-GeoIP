...
function SpecificIP<Props>({ setSpecificIpData }: any) {
    ...
    const [specificApiData, setSpevificApiData] = useState<SpecificApiData>(
        {} as any
    );
    ...
    function GetSpecificIP(ip: string) {
        setinputIP("");
        fetch(
            `https://api.freegeoip.app/json/${ip}?apikey=0ef75800-9419-11ec-b1aa-f93e522458e7`,
            {
                method: "GET",
            }
        )
        ...
        return (
            <div className="data-container-right">
                ...
                <div>
                    <p> City/Zip-code: </p>
                    <p>
                        {specificApiData.city} {specificApiData.zip_code}
                    </p>
                </div>
                <div>
                    <p>Lattude: </p>
                ...
                <div id="text">
                    ...
                    <p id="error">{error}</p>
                    <button onClick={() => GetSpecificIP(inputIP)}>
                        Check
                    </button>
                </div>
            </div>
